  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "bg-background fixed z-50 flex flex-col gap-4 shadow-lg transition data-[state=open]:animate-in data-[state=closed]:animate-out",
          side === "right" &&
      ...
      >
        {children}
        <SheetPrimitive.Close className="absolute right-4 top-4 rounded opacity-70 hover:opacity-100 focus:outline-none focus:ring-2">
...
function SheetHeader(props: React.ComponentProps<"div">) {
  return <div data-slot="sheet-header" className="p-4" {...props} />;
}

function SheetFooter(props: React.ComponentProps<"div">) {
  return <div data-slot="sheet-footer" className="mt-auto p-4" {...props} />;
}
